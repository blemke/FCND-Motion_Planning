...
class MotionPlanning(Drone):
    ...
    def __init__(self, connection, global_goal_position):
    ...
    def plan_path(self):
        ...
        print('grid_start_type ' + str(type(grid_start)))
        print('grid_goal_type ' + str(type(grid_goal)))
        path, _ = a_star(grid, heuristic, grid_start, grid_goal)
        print('unpruned path is of length ' + str(len(path)))
...
if __name__ == "__main__":
    ...
    #TODO: Review problematic collision this location causes.  This is probably from inaccurate collider data?
    #global_goal_position = (-122.396368, 37.793942, 0.0) 
